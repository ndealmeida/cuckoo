...
class SearchComparison:
    ...
    def run_elasticsearch_test(self):
        ...
        try:
            ...
            for doc in SAMPLE_DOCUMENTS:
                # TRANSFORMATION: ES prefers the ID passed separately from the body
                doc_id = str(doc["id"])
                # We can pass the whole dict as the body
    ...
    def run_vespa_test(self):
        ...
        try:
            ...
            for doc in SAMPLE_DOCUMENTS:
                # TRANSFORMATION: Vespa uses the schema name and a data_id string
                # The 'id' must also be in fields if it's in the schema definition
                data_id = str(doc["id"])
...
if __name__ == "__main__":
    container = Injector()
    app = container.get(SearchComparison)
    app.run_elasticsearch_test()
    app.run_vespa_test()
